...
import GooglePlaces
import CoreLocation
protocol ProtocolToSendData {
    func setResultOfBusinessLogic(valueSent: addressMap)
}

class pickPlaceViewController: UIViewController , UITextFieldDelegate ,CLLocationManagerDelegate{
    ...
    var shopname = ""
    var licensce = ""
    var delegate:ProtocolToSendData?
    ...
    @IBAction func confirmAction(_ sender: Any) {
        ...
        delegate?.setResultOfBusinessLogic(valueSent: addressFrom)
...
extension pickPlaceViewController: GMSAutocompleteViewControllerDelegate {
...
//1
extension pickPlaceViewController {
    // 2
...
extension pickPlaceViewController: GMSMapViewDelegate {
